...
INSERT INTO BLOC (art, aOrder, type, title, texte, image_uml) VALUES (1, fOrdreBloc(1),'T', 'Intro','Vincent Lindon meilleur acteur, Emmanuelle Bercot co-meilleure actrice, Dheepan, de Jacques Audiard et sa Palme d''or… les artistes français ont été particulièrement distingués lors de ce 68e Festival de Cannes. Découvrez le palmarès de l''édition 2015, présidée par les frères Joel et Ethan Coen.',NULL);
INSERT INTO BLOC (art, aOrder, type, title, texte, image_uml) VALUES (1, fOrdreBloc(1),'T', 'La Palme d''or','C''est pour Jacques Audiard et son film Dheepan, un thriller politique réussi sur l''exil de Tamouls en banlieue parisienne. « Recevoir un prix de la part des frères Coen c''est quelque chose d''assez exceptionnel », a déclaré le réalisateur de 63 ans, très ému, ajoutant qu''il « pensait à (son) père », le scénariste et dialoguiste Michel Audiard.', NULL);
INSERT INTO BLOC (art, aOrder, type, title, texte, image_uml) VALUES (1, fOrdreBloc(1),'I', 'La Palme d''or', NULL, '/image/1.1.jpg');
INSERT INTO BLOC (art, aOrder, type, title, texte, image_uml) VALUES (1, fOrdreBloc(1), 'Le prix d''interprétation féminine','Ex-aequo pour Rooney Mara et Emmanuelle Bercot. L''Américaine pour son rôle dans Carol, de Todd Haynes, la Française pour Mon roi, de Maïwenn, dont elle a salué « le sens aigu et l''anticonformisme ».',NULL);
INSERT INTO BLOC (art, aOrder, type, title, texte, image_uml) VALUES (1, fOrdreBloc(1), 'Le prix d''interprétation féminine', NULL, '/image/1.2.jpg');
INSERT INTO BLOC (art, aOrder, type, title, texte, image_uml) VALUES (1, fOrdreBloc(1), 'T','Le prix d''interprétation masculine','Pour Vincent Lindon et sa performance dans La Loi du marché, de Stéphane Brizé. L''acteur est paru très ému avec « ce premier prix qu''il reçoit dans sa vie ». « Je dédie ce prix aux citoyens laissés pour compte » , a-t-il notamment ajouté, référence au rôle de chômeur qu''il joue dans le film de Brizé.', NULL);
INSERT INTO BLOC(art, aOrder, type, title, texte, image_uml) VALUES (1, fOrdreBloc(1), 'I','Le prix d''interprétation masculine', NULL, '/image/1.3.jpg');
...
INSERT INTO BLOC (art, aOrder, type, title, texte, image_uml) VALUES (4, fOrdreBloc(4), 'T','Info',' Un lent ballet d’Homo smartphonicus ondule, téléphones portables en main, sur une houle sonore mariant chant ­tibétain et Early Morning ­Melody, de Meredith Monk. Puis se transforme en groupe d’oiseleurs imprimant dans l’air des sismographies de chants d’oiseaux : les expériences de musique interactive lancées avec le Collective Sound Checks ­seront au programme de la vaste journée portes ouvertes du Festival ManiFeste, journée qui se déroulera le 6 juin, de 15 heures à 21 heures.', NULL);
INSERT INTO BLOC (art, aOrder, type, title, texte, image_uml) VALUES (4, fOrdreBloc(4), 'I','image extraite du spectacle « Il se trouve que les oreilles n’ont pas de paupières », de Benjamin Dupé, programmé à Montreuil du 18 au 20 juin', NULL, '/image/4.1.jpg');
INSERT INTO BLOC (art, aOrder, type, title, texte, image_uml) VALUES (4, fOrdreBloc(4), 'T','Relégué aux oubliettes',' Relégué aux oubliettes, le temps où l’Ircam (Institut de recherche et coordination acoustique/musique) mitonnait dans les sous-sols de la place Igor-Stravinsky des logiciels complexes pour compositeurs érudits. Depuis quelque trois décennies, la synthèse vocale, pierre de touche de la geste ircamienne, s’est répandue comme une traînée de poudre dans les dessins animés, jeux vidéo, cinéma ou la création contemporaine. Tout s’est accéléré en 2001 avec la création de K, de Philippe Manoury, à l’Opéra de ­Paris.', NULL);
...
INSERT INTO BLOC (art, aOrder, type, title, texte, image_uml) VALUES (5, fOrdreBloc(5), 'I','La sortie des deux nouveaux modèles haut de gamme de téléphones de Samsung, le Galaxy S6 et sa version incurvée Edge, est prévue pour vendredi 10 avril', NULL, '/image/5.1.jpg');
INSERT INTO BLOC (art, aOrder, type, title, texte, image_uml) VALUES (5, fOrdreBloc(5), 'T','Le vent tournerait-il pour Samsung ?','Le vent tournerait-il pour Samsung ? Depuis la fin 2014, le bruit de fond autour du géant sud-coréen est plutôt négatif. Mais la commercialisation, vendredi 10 avril, de son nouveau smartphone, le Galaxy S6, et de sa version incurvée Edge pourrait inverser la tendance. Le vice-président de la branche mobile du conglomérat, Lee Sang-chul, a indiqué vendredi attendre « des ventes record » dans l’histoire du groupe. Ce qui place la barre au-delà des 70 millions de terminaux vendus, chiffre atteint par le Galaxy S4, commercialisé en 2013.', NULL);
INSERT INTO BLOC (art, aOrder, type, title, texte, image_uml) VALUES (5, fOrdreBloc(5), 'T','20 millions de modèles commandés','Alors du côté de Suwon, le siège de la marque, au sud de Séoul, on n’hésite pas à écrire la chronique d’un succès annoncé. Début mars, un cadre dirigeant du groupe confiait anonymement au Korea Times que les opérateurs avaient précommandé 20 millions de ces deux nouveaux modèles haut de gamme. Un chiffre « record » selon cette source.
...
INSERT INTO BLOC (art, aOrder, type, title, texte, image_uml) VALUES (5, fOrdreBloc(5), 'T','Améliorer la rentabilité de l’activité des semi-conducteurs','
...
INSERT INTO BLOC (art, aOrder, type, title, texte, image_uml) VALUES (6, fOrdreBloc(6), 'T','Arrivée dans les Apple Store','Pour se rendre compte de la réalité ou non du succès de l’Apple Watch peut-être faut-il attendre que les modèles soient enfin commercialisés dans les Apple Store. Jusqu’à aujourd’hui, les ventes n’étaient réalisées que sur internet et dans quelques boutiques sélectionnées à travers le monde. En France, c’est le magasin parisien branché Colette qui a obtenu ce privilège.
...
INSERT INTO BLOC (art, aOrder, type, title, texte, image_uml) VALUES (7, fOrdreBloc(7), 'I','François Hollande le 2 juin, à Paris', NULL, '/image/7.1.jpg');
INSERT INTO BLOC (art, aOrder, type, title, texte, image_uml) VALUES (7, fOrdreBloc(7), 'T','Info','François Hollande a du goût pour la métaphysique. Il déclarait récemment en Haïti : « On ne peut pas changer l’histoire, on peut changer l’avenir. » C’est une question pour les philosophes, qui ne peut laisser les économistes indifférents.
